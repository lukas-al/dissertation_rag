...
class V5Retriever(AbstractRetriever):
    ...
    def calculate_distance(self, doc1: Document, doc2: Document) -> float:
        ...
        ner_score = self.calculate_ner_distance(
            doc1_named_entities, doc2_named_entities
        )
    ...
    def calculate_ner_distance(
        self, named_entities1: List[str], named_entities2: List[str]
    ) -> float:
